...
export const Goalform: React.FC<IGoalFormProps> = () => {
    ...
    const addTask = (): void => {
        const newTask = { taskName: task, taskDescription: description, amountSpent: amount, deadline: deadline };
    ...
    const modifyTask = (taskNameToModify: string): void => {
        let index = goalList.findIndex(element => element.taskName === taskNameToModify);
        console.log(index);
    ...
    return (
        <div className="App">
            ...
            <div className="goalList">
                ...
                return <Goaltask key={key} task={task} completeTask={completeTask} modifyTask={modifyTask} />;
                })}
            </div>
        </div>
    )
